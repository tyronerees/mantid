...
void ConvolutionFitSequential::init() {
  ...
  declareProperty(
	  new WorkspaceProperty<WorkspaceGroup>("GroupOutputWorkspace", "", Direction::Output),
...
void ConvolutionFitSequential::exec() {
  ...
  deleter = createChildAlgorithm("DeleteWorkspace", -1, -1, true);
