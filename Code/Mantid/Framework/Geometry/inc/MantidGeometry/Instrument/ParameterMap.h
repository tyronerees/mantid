...
public:
  ...
  ParameterMap(const ParameterMap &other)
      : m_map(other.m_map), m_cacheLocMap(other.m_cacheLocMap),
        m_cacheRotMap(other.m_cacheRotMap),
        m_boundingBoxMap(other.m_boundingBoxMap), m_positionCache(),
        m_rotationCache(), m_boundingBoxCache(), m_mapAccess(){};
