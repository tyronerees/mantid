...
by the ConvertMDHistoToMDEventWorkspace algorithm.
...
public:
  FileContentsBuilder() : 
      m_DimensionBlock(ConvertMDHistoToMDEventWorkspace::DimensionBlockFlag()),
        m_MDEventsBlock(ConvertMDHistoToMDEventWorkspace::MDEventBlockFlag()),
...
{
  ConvertMDHistoToMDEventWorkspace alg;
  alg.initialize();
...
public:
  ...
  static ConvertMDHistoToMDEventWorkspaceTest *createSuite() { return new ConvertMDHistoToMDEventWorkspaceTest(); }
  static void destroySuite( ConvertMDHistoToMDEventWorkspaceTest *suite ) { delete suite; }
  ...
  {
    ConvertMDHistoToMDEventWorkspace alg;
    TS_ASSERT_EQUALS("ConvertMDHistoToMDEventWorkspace", alg.name());
  }
  ...
  void test_mdevent_block_declared_before_dimension_block_throws()
  {
    ...
    FileContentsBuilder fileContents;
    fileContents.setDimensionBlock(ConvertMDHistoToMDEventWorkspace::MDEventBlockFlag());
    fileContents.setMDEventBlock(ConvertMDHistoToMDEventWorkspace::DimensionBlockFlag());
    MDFileObject infile(fileContents);
    // Run the test.
    do_check_throws_invalid_alg_upon_execution(infile);
  }
  ...
  void test_ignore_comment_lines()
  {
    ...
    fileContents.setDimensionBlock("# Some Comment!\n" + ConvertMDHistoToMDEventWorkspace::DimensionBlockFlag());
    fileContents.setMDEventBlock("# Some Comment!\n" + ConvertMDHistoToMDEventWorkspace::MDEventBlockFlag());
...
Performance Tests
*/
class ConvertMDHistoToMDEventWorkspaceTestPerformance : public CxxTest::TestSuite
{
private:
...
public:
  static ConvertMDHistoToMDEventWorkspaceTestPerformance *createSuite() { return new ConvertMDHistoToMDEventWorkspaceTestPerformance(); }
  static void destroySuite( ConvertMDHistoToMDEventWorkspaceTestPerformance *suite ) { delete suite; }

  ConvertMDHistoToMDEventWorkspaceTestPerformance() : nRows(10000)
  {
  }
